...
-- Users
INSERT INTO users (id, nickname, firstname, lastname, email, password, balance, rating, creation_date, region_id, userclass) VALUES (1, 'darryl', 'Darryl', 'Sloan', 'Darryl.Sloan@mail.com', 'JKX29UWD9HQ', 500.50, 10, CAST ({fn TIMESTAMPADD(SQL_TSI_DAY, -50, CURRENT_TIMESTAMP)} as DATE), 10, 'GOLD');
INSERT INTO users (id, nickname, firstname, lastname, email, password, balance, rating, creation_date, region_id, userclass) VALUES (2, 'ethan', 'Ethan', 'Benson', 'Ethan.Benson@mail.com', 'OKK69ZXQ7MI', 0.00, 8, CAST ({fn TIMESTAMPADD(SQL_TSI_DAY, -55, CURRENT_TIMESTAMP)} as DATE), 10, 'SILVER');
INSERT INTO users (id, nickname, firstname, lastname, email, password, balance, rating, creation_date, region_id, userclass) VALUES (3, 'shelly', 'Shelly', 'Franklin', 'Shelly.Franklin@mail.com', 'GLZ43DIN6SS', 350.00, 7, CAST ({fn TIMESTAMPADD(SQL_TSI_DAY, -60, CURRENT_TIMESTAMP)} as DATE), 16, 'SILVER');
